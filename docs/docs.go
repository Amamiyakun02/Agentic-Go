    ...
    "paths": {
        "/v1/admin/sync-device-apps": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "App Inventory Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SyncDeviceAppsRequest"
                        }
                    }
                ],
                "responses": {
